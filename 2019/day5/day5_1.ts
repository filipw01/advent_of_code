...
function parseInstruction(
  ...
  switch (Number(opcode)) {
    case 1:
      numberOne = getWithMode(modes[2], input, baseParamIndex);
    ...
    case 3:
      setTable(input, baseParamIndex, 1);
      console.log("input: 1");
      return 2;
    ...
    case 5:
      numberOne = getWithMode(modes[1], input, baseParamIndex);
      numberTwo = getWithMode(modes[0], input, baseParamIndex + 1);
      if (numberOne !== 0) {
